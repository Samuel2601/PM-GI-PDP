...
export class AdminService {
  ...
  agregar_ctacontable(token: any, data: any): Observable<any> {
    ...
    return this._http.post(this.url + 'agregar_ctacontable', data, {
      headers: headers,
    });
  }
  cambiarEstadoGoogle(token: any, data: any): Observable<any> {
    ...
    return this._http.post(this.url + 'cambiarEstadoGoogle', data, {
      headers: headers,
    });
  }
  ...
  consultarEstadoGoogle(token: any, id: any): Observable<any> {
    ...
    return this._http.get(this.url + 'consultarEstadoGoogle/' + id, {
      headers: headers,
    });
  }
  agregar_proveedor(token: any, data: any): Observable<any> {
    ...
    return this._http.post(this.url + 'agregar_proveedor', data, {
      headers: headers,
    });
  }
  ...
  listar_ctacontable(token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'listar_ctacontable', {
      headers: headers,
    });
  }
  ...
  actualizzas_dash(token: any, data: any): Observable<any> {
    ...
    return this._http.put(this.url + 'actualizzas_dash', data, {
      headers: headers,
    });
  }
  ...
  obtener_info_admin(token: any): Observable<any> {
    let headers = new HttpHeaders({
      'Content-Type': 'application/json',
      Authorization: token,
    });
    return this._http.get(this.url + 'obtener_info_admin', {
      headers: headers,
    });
  }
  obtener_config_plana(token: any): Observable<any> {
    let headers = new HttpHeaders({
      'Content-Type': 'application/json',
      Authorization: token,
    });
    return this._http.get(this.url + 'obtener_config_plana', {
      headers: headers,
    });
  }
  obtener_institucion(id: any, token: any): Observable<any> {
    let headers = new HttpHeaders({
      'Content-Type': 'application/json',
      Authorization: token,
    });
    return this._http.get(this.url + 'obtener_institucion/' + id, {
      headers: headers,
    });
  }
  crear_config_plana(data: any): Observable<any> {
    let headers = new HttpHeaders().set('Content-Type', 'application/json');
    return this._http.post(this.url + 'crear_config_plana', data, {
      headers: headers,
    });
  }
  actualizar_config_plana(id: any, data: any, token: any): Observable<any> {
    let headers = new HttpHeaders({
      'Content-Type': 'application/json',
      Authorization: token,
    });
    return this._http.put(this.url + 'actualizar_config_plana/' + id, data, {
      headers: headers,
    });
  }
  ...
  balance(token: any): Observable<any> {
    const apiKey = 'DO002CF4YQ6CAA3PMRBF';
    const httpOptions = {
      headers: new HttpHeaders({
        'Content-Type': 'application/json',
  ...
  facturacion(wsdl: any): Observable<any> {
    ...
    return this._http.post(
      'http://181.113.65.229:8080/interfaceFacturaWeb/index.xhtml?',
      wsdl,
      {
        headers: headers,
      }
  ...
  registro_estudiante(data: any, token: any): Observable<any> {
    ...
    console.log('INFORMACIÓN POR ENVIAR', data);
    return this._http.post(this.url + 'registro_estudiante', data, {
      headers: headers,
    });
  }
  registro_estudiante_masivo(data: any, token: any): Observable<any> {
    ...
    return this._http.post(this.url + 'registro_estudiante_masivo', data, {
      headers: headers,
    });
  }
  borrado_estudiante_masivo(data: any, token: any): Observable<any> {
    ...
    return this._http.post(this.url + 'borrado_estudiante_masivo', data, {
      headers: headers,
    });
  }
  ...
  registro_admin(data: any, token: any): Observable<any> {
    ...
    return this._http.post(this.url + 'registro_admin', data, {
      headers: headers,
    });
  }
  ...
  eliminar_admin(id: any, token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'eliminar_admin/' + id, {
      headers: headers,
    });
  }
  ...
  forgotpassword(data: any): Observable<any> {
    let headers = new HttpHeaders().set('Content-Type', 'application/json');
    return this._http.post(this.url + 'forgotpassword', data, {
      headers: headers,
    });
  }
  ...
  create_institucion(data: any, file: any): Observable<any> {
    ...
    return this._http.post(this.url + 'create_institucion', fd, {
      headers: headers,
    });
  }
  ...
  listar_estudiantes_tienda(token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'listar_estudiantes_tienda', {
      headers: headers,
    });
  }
  ...
  listar_pensiones_estudiantes_tienda(token: any, id: any): Observable<any> {
    ...
    return this._http.get(
      this.url + 'listar_pensiones_estudiantes_tienda/' + id,
      {
        headers: headers,
      }
    );
  ...
  listar_admininstitucion(token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'listar_admininstitucion', {
      headers: headers,
    });
  }
  ...
  actualizar_estudiante_admin(id: any, data: any, token: any): Observable<any> {
    ...
    return this._http.put(
      this.url + 'actualizar_estudiante_admin/' + id,
      data,
      {
        headers: headers,
      }
  ...
  listar_etiquetas_admin(token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'listar_etiquetas_admin', {
      headers: headers,
    });
  }
  ...
  listar_documentos_admin(token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'listar_documentos_admin', {
      headers: headers,
    });
  }
  ...
  eliminar_etiqueta_documento_admin(id: any, token: any): Observable<any> {
    ...
    return this._http.delete(
      this.url + 'eliminar_etiqueta_documento_admin/' + id,
      {
        headers: headers,
      }
    );
  ...
  agregar_etiqueta_documento_admin(data: any, token: any): Observable<any> {
    ...
    return this._http.post(
      this.url + 'agregar_etiqueta_documento_admin',
      data,
      {
        headers: headers,
      }
  ...
  actualizar_documento_variedades_admin(
    data: any,
    id: any,
    token: any
  ): Observable<any> {
    ...
    return this._http.put(
      this.url + 'actualizar_documento_variedades_admin/' + id,
      data,
      {
        headers: headers,
      }
  ...
  listar_inventario_documento_admin(id: any, token: any): Observable<any> {
    ...
    return this._http.get(
      this.url + 'listar_inventario_documento_admin/' + id,
      {
        headers: headers,
      }
    );
  ...
  registro_inventario_documento_admin(data: any, token: any): Observable<any> {
    ...
    return this._http.post(
      this.url + 'registro_inventario_documento_admin',
      data,
      {
        headers: headers,
      }
  ...
  listar_cupones_admin(token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'listar_cupones_admin', {
      headers: headers,
    });
  }
  ...
  cambiar_vs_documento_admin(
    ...
    return this._http.get(
      this.url + 'cambiar_vs_documento_admin/' + id + '/' + estado,
      {
        headers: headers,
      }
    );
  ...
  obtener_pagos_admin(token: any, desde: any, hasta: any): Observable<any> {
    let headers = new HttpHeaders({
      'Content-Type': 'application/json',
      Authorization: token,
    });
    ...
    // Usamos comillas inversas para interpolar las variables en la URL
    return this._http.get(`${this.url}obtener_pagos_admin/${desde}/${hasta}`, {
      headers: headers,
    });
  }
  obtener_pagos_dash(token: any, desde: any, hasta: any): Observable<any> {
    let headers = new HttpHeaders({
      'Content-Type': 'application/json',
      Authorization: token,
    });
    ...
    // Usamos comillas inversas para interpolar las variables en la URL
    return this._http.get(`${this.url}obtener_pagos_dash/${desde}/${hasta}`, {
      headers: headers,
    });
  }
  ...
  obtener_detallespagos_admin(token: any, id: any): Observable<any> {
    ...
    return this._http.get(this.url + 'obtener_detallespagos_admin/' + id, {
      headers: headers,
    });
  }
  ...
  obtener_detalles_ordenes_estudiante_abono(
    ...
    return this._http.get(
      this.url + 'obtener_detalles_ordenes_estudiante_abono/' + id,
      {
        headers: headers,
      }
    );
  ...
  obtener_detalles_ordenes_estudiante(id: any, token: any): Observable<any> {
    ...
    return this._http.get(
      this.url + 'obtener_detalles_ordenes_estudiante/' + id,
      {
        headers: headers,
      }
    );
  ...
  /*
	eliminar_orden_pm(id: any, token: any): Observable<any> {
		let headers = new HttpHeaders({
			'Content-Type': 'application/json',
			Authorization: token,
		});
		return this._http.delete(this.url + 'eliminar_orden_pm/' + id, {
			headers: headers,
		});
	}*/
  ...
  obtener_direccion_todos_estudiante(id: any, token: any): Observable<any> {
    ...
    return this._http.get(
      this.url + 'obtener_direccion_todos_estudiante/' + id,
      {
        headers: headers,
      }
    );
  ...
  registro_compra_manual_estudiante(data: any, token: any): Observable<any> {
    ...
    return this._http.post(
      this.url + 'registro_compra_manual_estudiante',
      data,
      {
        headers: headers,
      }
  ...
  //Registro PAGO
  listar_estudiantes_pago(token: any): Observable<any> {
    let headers = new HttpHeaders({
      'Content-Type': 'application/json',
      Authorization: token,
    });
    return this._http.get(this.url + 'listar_estudiantes_pago', {
      headers: headers,
    });
  }
