...
api.get('/obtener_pagos_admin/:desde/:hasta',auth.auth,AdminController.obtener_pagos_admin);
api.get('/obtener_pagos_dash/:desde/:hasta',auth.auth,AdminController.obtener_pagos_dash);
...
api.delete('/eliminar_orden_pm/:id',auth.auth,AdminController.eliminar_orden_pm);
...
api.get('/listar_registro/:desde/:hasta',auth.auth,AdminController.listar_registro);
...
api.get('/obtener_institucion/:id',auth.auth,AdminController.obtener_institucion);
